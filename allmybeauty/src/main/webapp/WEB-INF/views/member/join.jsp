	...
	var data = {mid : mid} // 컨트롤에 넘길 이름 : 데이터(input에 입력되는 값)
	   ...
	   $.ajax({
	      ...
	      success : function(idExistResult){
	         console.log("중복 여부 : " + idExistResult); //web console.
	         if(mid != ""){ //아이디가 입력된 상태
