      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${contextPath }">ALL MY BEAUTY</a>
          </div>
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="index_shop.html">LOGIN</a></li>
              <li><a href="index_shop.html">SIGN UP</a></li>
              <li><a href="index_shop.html">CART</a></li>
              <li><a href="index_shop.html">Q&amp;A</a></li>
              <li><a href="index_shop.html">MY PAGE</a></li>
