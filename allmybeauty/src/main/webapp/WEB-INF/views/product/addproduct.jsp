						            ...
						            <div class="tab-pane active" id="Menubars1">
                    			        ...
                    			        <div class="tab-pane" id="Menubars2">                    			      
                        			    	<div class="row" id="proIngre">  
	                        			    	<form role="form">
								                  <div class="search-box compKeywordDiv">
								                  	<label for="keyword" style="padding:left">선택할 성분 검색</label>
								                    <input class="form-control" type="text" name="compKeyword" placeholder="성분명을 입력하세요." onkeyup="search(this);"/>
								                  </div>
								                  <div class="search-box keywordform">
                                                    <label for="keyword">선택된 성분 검색</label>
                                                    <input class="form-control" type="text" name="compKeyword" placeholder="성분명2을 입력하세요." onkeyup="search(this);" />   
                                                  </div>
								                </form><br>
        ...
        console.log(keyword);
           ...
           $.ajax({
               ...
               success: function(result){
                   ...
                   var temp ="<c:forEach items='${componentList}' var='comp'>"
                          +"<li style='font-size: 15px;'>"
                             +"<input type='checkbox' class='selectComponent' name='component' value='${comp.comno }'>&nbsp;${comp.comname}"
                             +"</li></c:forEach>" ;
