        ...
        <div class="SortBy" style="margin-left: 350px;">
             <ul>
           	   <li class="selectSortTab" data-selecttab="sortthumb">
              		<button type="button" class="selectButton"><i class="fa fa-check" style="display:none"></i>추천순</button>
           	   </li>
               <li class='selectSortTab' data-selecttab="sortprice">
              		<button type="button" class="selectButton"><i class="fa fa-check" style="display:none"></i>높은 가격순</button>
           	   </li>
           	   <li class='selectSortTab' data-selecttab="sortlowprice">
              		<button type="button" class="selectButton"><i class="fa fa-check" style="display:none"></i>낮은 가격순</button>
           	   </li>
             </ul>
		</div>
        <section class="module-small">
