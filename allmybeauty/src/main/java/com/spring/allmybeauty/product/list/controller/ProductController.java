...
public class ProductController {
	...
	public void addProduct(Model model) {
		model.addAttribute("componentList", productService.getComponentList());
	}
	...
	public List<ComponentVO> searchComponent(ComponentVO component, Model model) {
		
		model.addAttribute("componentList", productService.searchComponent(component));
		
		return productService.searchComponent(component);
	}
